...
echo "<form action='http://iavik.infinityfreeapp.com/3iAvikRegistrerNyHendelse.php' method='post'>";
...
echo "<form action='http://iavik.infinityfreeapp.com/5iAvikOppslagstabell.php' method='post'>";
...
if ( isset($_SESSION['innlogget']) ) {
    echo "<form action='5iAvikUtlogging.php' method='post'>";
